#
# Module manifest for module 'Slack.Scripts'
#
# Generated by: adamr
#
...
@{
    ...
    RequiredModules   = @('Universal.Scripts')
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ProjectUri  = 'https://github.com/ironmansoftware/scripts/blob/main/Notification/Slack.Scripts'
